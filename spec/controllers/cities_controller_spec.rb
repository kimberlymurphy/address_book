  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested city" do
        ...
        City.any_instance.should_receive(:update).with({ "name" => "MyText" })
        put :update, {:id => city.to_param, :city => { "name" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the city as @city" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        City.any_instance.stub(:save).and_return(false)
        put :update, {:id => city.to_param, :city => { "name" => "invalid value" }}, valid_session
        assigns(:city).should eq(city)
      end
